...
from recbole.model.constrast_class_component import ConstrastComponent
from recbole.model.init import xavier_uniform_initialization
from recbole.model.loss import BPRLoss, EmbLoss
from recbole.utils import InputType


class CECL(ConstrastComponent):
    ...
    def __init__(self, config, dataset):
        super(CECL, self).__init__(config, dataset)
    ...
    def calculate_loss(self, interaction):
        ...
        if self.addc:
            result = mf_loss + self.reg_weight * reg_loss, ssl_loss, self.class_loss(center_embedding, user, pos_item),self.ProtoNCE_loss(center_embedding, user, pos_item)
        else:
            result = mf_loss + self.reg_weight * reg_loss, ssl_loss
        return result
