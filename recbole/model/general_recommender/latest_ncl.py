...
class NCL(ConstrastComponent):
    ...
    def calculate_loss(self, interaction):
        ...
        return mf_loss + self.reg_weight * reg_loss, ssl_loss, self.class_loss(center_embedding, user, pos_item) + \
               self.ProtoNCE_loss(center_embedding, user, pos_item)
