...
def ray_tune(args):
    ...
    if os.path.exists("./properties/dataset/{}.yaml".format(args.dataset)):
        config_file_list.append("./properties/dataset/{}.yaml".format(args.dataset))
    if os.path.exists("./properties/model/{}.yaml".format(args.model)):
        config_file_list.append("./properties/model/{}.yaml".format(args.model))
...
if __name__ == "__main__":
    ...
    if args.config_files:
        args.config_files = " ".join(set(args.config_files.split(" ") + config_file_list))
    else:
        args.config_files = " ".join(config_file_list)
